  ...
  <section class="project-info">
    ...
    <main>
      <span>
        ...
        <b title={data.project!.title}>{data.project!.title}</b>
        <p title={data.project!.tagline}>{data.project!.tagline}</p>
      </span>

      <section class="details">
        {const statusOf = projectMeta.status[data.project!.status]}
        ...
        <div>
          ...
          <span>
            <CalendarRange />
            <p>
              {data.project!.timeframe[0]}{#if data.project!.timeframe[0] !== data.project!.timeframe[1]}-{data.project!.timeframe[0] !== data.project!.timeframe[1] && data.project!.timeframe[1] === true ? "now" : data.project!.timeframe[1]}{/if}
            </p>
          </span>
        </div>
        ...
        <div>
          <b>Featured</b>
          <span>
            {#if data.project!.featured}<Star />{:else}<StarOff />{/if}
            {data.project!.featured ? "Yes" : "No"}
          </span>
        </div>
      </section>
    </main>
  ...
  <div class="project-body">
    <main>
      <Box label="description" class="markdown-content">
        <PostMarkdown source={data.project!.description} />
      </Box>

      {#if data.project!.gallery.length > 0}
        <Box label="gallery">
          <div class="gallery">
            {#each data.project!.gallery as url, i (i)}
